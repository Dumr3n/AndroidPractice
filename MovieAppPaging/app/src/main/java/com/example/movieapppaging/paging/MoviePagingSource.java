package com.example.movieapppaging.paging;
...
import com.example.movieapppaging.api.APIClient;
    ...
    public Single<LoadResult<Integer, Movie>> loadSingle(@NonNull LoadParams<Integer> loadParams) {
        try {
            ...
            return APIClient.getApiInterface()
                    ...
                    .map(movies -> toLoadResult(movies, page)).onErrorReturn(LoadResult.Error::new);
        } catch (Exception e) {
